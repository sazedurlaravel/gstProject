  ...
  <div class="card card-primary">
    ...
    <form role="form" action={{$editData? route('unit.update',$editData->id):route('unit.store')}} method="POST">
      ...
      <div class="card-body">
        ...
        <div class="form-group">
            <label for="exampleInputEmail1">Assign Amount</label>
            <input type="text" class="form-control" id="amount" name="amount" placeholder="Enter Amount" value="{{$editData? $editData->amount:""}}">
